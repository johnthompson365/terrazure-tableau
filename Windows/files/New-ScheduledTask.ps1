...
# Start-Process powershell -ArgumentList '-noprofile -executionpolicy bypass -file C:\jt365\wintab-deploy-original.ps1' -verb RunAs
# Invoke-Expression -Command "C:\jt365\wintab-deploy-original.ps1" 
